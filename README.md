...
> [!NOTE]
> This unofficial version was forked from v0.0.5 & contains bug fixes that were left unresolved by the original source for over a year despite PRs being opened. _The primary fix resolves an error that was displaying in the terminal anytime the Micro editor started._
